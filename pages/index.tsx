...
const Home: NextPage = () => {
	...
	return (
		<>
			...
			<ButtonLink text="Read my Blogs" url="/blogs" delay={0.2} />
			<Welcoming delay={0.3}/>
			...
			<Description title="Pastimes" delay={0.5} description={[
				"I like to watch movies, play games, and listen to music. I also like to make cinematics and make videos.",
			]} />
			<Socials delay={0.6} />
			<ButtonLink text="See my projects" url="/projects" delay={0.7} />
		</>
	)
}
