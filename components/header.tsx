						...
						<div className="cursor-pointer">
							<Link passHref href="https://github.com/leogadil/website" scroll={false}>
								<a target="_blank" rel="noopener noreferrer">
									<button className="hover:dark:bg-main-accent hover:bg-accent-2 flex flex-row items-center justify-center w-full p-3 text-md hover:text-th-light transition-colors" onClick={() => setBurgerisOpen(false)}>
					...
					<div className="flex flex-row items-center">
						<ul className="flex mr-4">
							...
							<li className="flex-1 cursor-pointer text-lg hidden sm:block">
								...
								<div className={"w-full h-1 rounded bg-transparent dark:bg-transparent transition-colors "}>
								</div>
							</li>
